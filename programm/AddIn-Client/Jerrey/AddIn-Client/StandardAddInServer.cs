...
namespace AddIn_Client
{
    ...
    /// </summary>
    [GuidAttribute("8b917585-acbf-4f84-8fed-f60169342570")]
    public class StandardAddInServer : Inventor.ApplicationAddInServer
    {
        ...
        public void Activate(Inventor.ApplicationAddInSite addInSiteObject, bool firstTime)
        {
            ...
            try
            {
                ...
                Icon icon5 = Properties.Resources.moderator;
                ...
                InventorButton button5 = new InventorButton(
                    "Moderator", "InventorAddinServer.Button_" + Guid.NewGuid().ToString(), "Button 1 description", "Moderatorrechte greifen",
                    icon5, icon5,
                    CommandTypesEnum.kShapeEditCmdType, ButtonDisplayEnum.kDisplayTextInLearningMode);
                ...
                if (firstTime == true)
                {
                    ...
                    if (uiMan.InterfaceStyle == InterfaceStyleEnum.kRibbonInterface) //kClassicInterface support can be added if necessary.
                    {
                        ...
                        cmdCtrls.AddButton(button5.ButtonDef, button5.DisplayBigIcon, button5.DisplayText, "", button5.InsertBeforeTarget);
                        ...
                        //CommandBarList ContextMenuList/ CommandBar DefaultMenuBar
                        AddinGlobal.RibbonPanelId = "{d04e0c45-dec6-4881-bd3f-a7a81b99f307}";
                        AddinGlobal.RibbonPanel = modelRibbonTab.RibbonPanels.Add(
                            "AddOutButtons",
                            "AddOutButtons.RibbonPanel_" + Guid.NewGuid().ToString(),
                            AddinGlobal.RibbonPanelId, String.Empty, true);

                        CommandControls pcmdCtrls = AddinGlobal.RibbonPanel.CommandControls;
                        ...
                        pcmdCtrls.AddButton(button5.ButtonDef, button5.DisplayBigIcon, button5.DisplayText, "", button5.InsertBeforeTarget);
                        ...
                        //CommandBarList ContextMenuList/ CommandBar DefaultMenuBar
                        AddinGlobal.RibbonPanelId = "{d04e0c45-dec6-4881-bd3f-a7a81b99f307}";
                        AddinGlobal.RibbonPanel = drawingRibbonTab.RibbonPanels.Add(
                            "AddOutButtons",
                            "AddOutButtons.RibbonPanel_" + Guid.NewGuid().ToString(),
                            AddinGlobal.RibbonPanelId, String.Empty, true);

                        CommandControls dcmdCtrls = AddinGlobal.RibbonPanel.CommandControls;
                        ...
                        dcmdCtrls.AddButton(button5.ButtonDef, button5.DisplayBigIcon, button5.DisplayText, "", button5.InsertBeforeTarget);
